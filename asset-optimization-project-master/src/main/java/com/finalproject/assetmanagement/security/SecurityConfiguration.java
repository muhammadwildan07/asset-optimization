...
public class SecurityConfiguration  {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            return http.httpBasic().and().csrf().disable()
                    ...
                    .antMatchers("/api/v1/transaction/update").hasRole("MANAGER")
//                    .antMatchers("/api/v1/transaction/update").permitAll()
                    .antMatchers("/api/v1/employee/**").hasRole("MANAGER")
                    .antMatchers("/api/v1//branch/**").hasRole("MANAGER")
                    .antMatchers("/api/v1/asset/**").hasRole("MANAGER")
